...
- [Managed Cluster Validating Webhooks](#validating-webhook-framework)
...
For example, in the image URI `quay.io/my-user/validating-webhook-framework:latest`:
- `quay.io` is the *registry*
- `my-user` is the *organization*
- `validating-webhook-framework` is the *repository*
...
- `BASE_IMG` overrides the *repository name* (default: `validating-webhook-framework`)
...
For example, to build, tag, and push `quay.io/my-user/validating-webhook-framework:latest`, you can run:
...
For example, if you created `quay.io/my-user/validating-webhook-framework:latest`, replace
```
        image: quay.io/app-sre/validating-webhook-framework@sha256:f33f879a9e8b0dc5b0481f75ba5eb8422a8a9b06acf70330794eb564ee31e9e5
```
with
```
        image: quay.io/my-user/validating-webhook-framework:latest
```
